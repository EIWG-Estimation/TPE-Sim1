/*******************************************************************
| Name       : dnar_linearchg_mi3_part1.sas
...
proc mixed data = mi3_y1;
  ...
  class groupn p1;
  model y1 = groupn patcode1 groupn*patcode1 baseline_var / noint residuals
...
proc mi data    = mi3 
  ...
  var groupn patcode2 baseline_var r1 y2 dummy;
  monotone reg (y2 = groupn patcode2 groupn*patcode2 baseline_var r1);
  monotone reg (dummy = baseline_var); *** TRICK TO KEEP MI HAPPY ***;
run;
...
proc mixed data = mi3_y2;
  by rdrate sim_run imputation;
  class groupn patcode2;
  model y2 = groupn patcode2 groupn*patcode2 baseline_var r1 / noint residuals
...
proc mi data    = mi3
  ...
  var groupn patcode3 baseline_var r1 r2 y3 dummy;
  monotone reg (y3 = groupn patcode3 groupn*patcode3 baseline_var r1 r2);
  monotone reg (dummy = baseline_var); *** TRICK TO KEEP MI HAPPY ***;
run;
...
proc mixed data = mi3_y3;
  by rdrate sim_run imputation;
  class groupn patcode3;
  model y3 = groupn patcode3 groupn*patcode3 baseline_var r1 r2 / noint residuals
...
proc mi data    = mi3
  ...
  var groupn patcode4 baseline_var r1 r2 r3 y4 dummy;
  monotone reg (y4 = groupn patcode4 groupn*patcode4 baseline_var r1 r2 r3);
  monotone reg (dummy = baseline_var); *** TRICK TO KEEP MI HAPPY ***;
run;
...
proc mixed data = mi3_y4;
  by rdrate sim_run imputation;
  class groupn patcode4;
  model y4 = groupn patcode4 groupn*patcode4 baseline_var r1 r2 r3 / noint residuals
...
proc mi data    = mi3_r4 
  ...
  var groupn patcode5 baseline_var r1 r2 r3 r4 y5;
  monotone reg (y5 = groupn patcode5 groupn*patcode5 baseline_var r1 r2 r3 r4);
run;
