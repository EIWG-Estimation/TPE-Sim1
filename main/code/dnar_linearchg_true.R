...
#  Purpose : Creates large number of sims as DNAR_LINEARCHG truth  
#       
# --------------------------------------------------------------
#  Notes:
#  
...
file_name = "data/dnar_linearchg_true.csv"
...
# Create CSV
write_csv(df_data_offtrt_dnar, file = file_name)
rm("df_data_offtrt_dnar")
