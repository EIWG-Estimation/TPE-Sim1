...
proc means data = dif_metrics nway noprint;
  where method in ("MMRM2" "MMRM3");           *** SUMMARIZE THE ADJUSTED UNCERTIANTY MEASURES ***;
  class rdrate methodn method visitn;
  var dif_policy_hw_adj dif_policy_cic_adj dif_policy_mse_adj dif_policy_pwr_adj dif_policy_pwr2_adj;
  output out = dif_summary2 (drop = _type_ _freq_)
    n     (dif_policy_hw_adj dif_policy_cic_adj dif_policy_mse_adj dif_policy_pwr_adj dif_policy_pwr2_adj) = dif_policy_hw_adj_n    dif_policy_cic_adj_n    dif_policy_mse_adj_n    dif_policy_pwr_adj_n    dif_policy_pwr2_adj_n   
    mean  (dif_policy_hw_adj dif_policy_cic_adj dif_policy_mse_adj dif_policy_pwr_adj dif_policy_pwr2_adj) = dif_policy_hw_adj_mean dif_policy_cic_adj_mean dif_policy_mse_adj_mean dif_policy_pwr_adj_mean dif_policy_pwr2_adj_mean 
    lclm  (dif_policy_hw_adj dif_policy_cic_adj dif_policy_mse_adj dif_policy_pwr_adj dif_policy_pwr2_adj) = dif_policy_hw_adj_lclm dif_policy_cic_adj_lclm dif_policy_mse_adj_lclm dif_policy_pwr_adj_lclm dif_policy_pwr2_adj_lclm
    uclm  (dif_policy_hw_adj dif_policy_cic_adj dif_policy_mse_adj dif_policy_pwr_adj dif_policy_pwr2_adj) = dif_policy_hw_adj_uclm dif_policy_cic_adj_uclm dif_policy_mse_adj_uclm dif_policy_pwr_adj_uclm dif_policy_pwr2_adj_uclm; 
run;  
