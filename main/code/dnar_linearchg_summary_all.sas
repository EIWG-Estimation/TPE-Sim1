/*******************************************************************
| Name       : dnar_linearchg_summary_all.sas
...
proc means data = dif_metrics nway noprint;
  ...
  var dif_policy_bias dif_policy_hw dif_policy_cic dif_policy_mse;
  output out = dif_summary1 (drop = _type_ _freq_)
    n     (dif_policy_bias dif_policy_hw dif_policy_cic dif_policy_mse) = dif_policy_bias_n    dif_policy_hw_n    dif_policy_cic_n    dif_policy_mse_n  
    mean  (dif_policy_bias dif_policy_hw dif_policy_cic dif_policy_mse) = dif_policy_bias_mean dif_policy_hw_mean dif_policy_cic_mean dif_policy_mse_mean 
    lclm  (dif_policy_bias dif_policy_hw dif_policy_cic dif_policy_mse) = dif_policy_bias_lclm dif_policy_hw_lclm dif_policy_cic_lclm dif_policy_mse_lclm
    uclm  (dif_policy_bias dif_policy_hw dif_policy_cic dif_policy_mse) = dif_policy_bias_uclm dif_policy_hw_uclm dif_policy_cic_uclm dif_policy_mse_uclm; 
run;  
...
proc means data = dif_metrics nway noprint;
  where method in ("MMRM2" "MMRM3");           *** SUMMARIZE THE ADJUSTED UNCERTIANTY MEASURES ***;
  class rdrate methodn method visitn;
  var dif_policy_hw_adj dif_policy_cic_adj dif_policy_mse_adj;
  output out = dif_summary2 (drop = _type_ _freq_)
    n     (dif_policy_hw_adj dif_policy_cic_adj dif_policy_mse_adj) = dif_policy_hw_adj_n    dif_policy_cic_adj_n    dif_policy_mse_adj_n     
    mean  (dif_policy_hw_adj dif_policy_cic_adj dif_policy_mse_adj) = dif_policy_hw_adj_mean dif_policy_cic_adj_mean dif_policy_mse_adj_mean 
    lclm  (dif_policy_hw_adj dif_policy_cic_adj dif_policy_mse_adj) = dif_policy_hw_adj_lclm dif_policy_cic_adj_lclm dif_policy_mse_adj_lclm
    uclm  (dif_policy_hw_adj dif_policy_cic_adj dif_policy_mse_adj) = dif_policy_hw_adj_uclm dif_policy_cic_adj_uclm dif_policy_mse_adj_uclm; 
run;  
